# Generated by Django 5.1 on 2025-02-23 12:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest_rate', models.DecimalField(blank=True, decimal_places=2, help_text='Interest rate in percentage', max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_status', models.CharField(choices=[('Paid', 'Paid'), ('UnPaid', 'UnPaid')], default='UnPaid', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('premium_amount', models.BigIntegerField(blank=True, null=True)),
                ('insurance_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Insurance', to='ERP_Admin.insurance_bank')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fitness_document', models.FileField(blank=True, null=True, upload_to='PolicyDocuments')),
                ('permit_document', models.FileField(blank=True, null=True, upload_to='PolicyDocuments')),
                ('puc_document', models.FileField(blank=True, null=True, upload_to='PolicyDocuments')),
                ('rc_book', models.FileField(blank=True, null=True, upload_to='PolicyDocuments')),
                ('invoice', models.FileField(blank=True, null=True, upload_to='PolicyDocuments')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ERP_Admin.driver')),
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ERP_Admin.vehicle')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio', models.FileField(blank=True, null=True, upload_to='Breakdown_Audio')),
                ...
                ('type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='breakdown_type', to='ERP_Admin.breakdowntype')),
                ('driver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='breakdown_driver', to='ERP_Admin.driver')),
                ('vehicle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='breakdown_vehicle', to='ERP_Admin.vehicle')),
            ],
        ),
        migrations.AddField(
            model_name='vehicle',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('joining_date_time', models.DateTimeField(blank=True, null=True)),
                ('leaving_date_time', models.DateTimeField(blank=True, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allocated_drivers', to='ERP_Admin.driver')),
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='allocated_vehicles', to='ERP_Admin.vehicle')),
            ],
            options={
