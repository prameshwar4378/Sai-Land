# Generated by Django 5.1 on 2024-12-12 19:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_file', models.FileField(blank=True, null=True, upload_to='Purchase Bill')),
            ],
        ),
        migrations.CreateModel(
            name='Technician',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completed_status', models.CharField(choices=[('pending', 'Pending'), ('in_progress', 'In Progress'), ('completed', 'Completed')], default='pending', max_length=20)),
                ...
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_cards', to='ERP_Admin.vehicle')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
