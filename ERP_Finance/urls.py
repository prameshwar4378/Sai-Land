...
urlpatterns = [
    path('daily_reminder_report_mail/', views.daily_reminder_mail, name='finance_daily_reminder_mail'),
    ...
    path('delete_emi_installment/<int:id>', views.delete_emi_installment, name='finance_delete_emi_installment'), 
